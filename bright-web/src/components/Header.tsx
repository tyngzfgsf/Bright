  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-4 px-5 sm:px-8">
        ...
        <nav className="hidden items-center gap-6 text-[13.5px] text-ink-soft lg:flex">
          {links.map((link) => {
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="grid size-9 place-items-center rounded-full border border-line text-ink-soft transition-colors duration-200 hover:text-ink lg:hidden"
          >
            <svg
              viewBox="0 0 24 24"
              className="size-[17px]"
      ...
      <AnimatePresence>
        {open && (
          <motion.nav
            ...
            className="overflow-hidden border-t border-line bg-paper/95 lg:hidden"
          >
            <div className="mx-auto flex max-w-6xl flex-col px-5 py-2 sm:px-8">
              {links.map((link) => (
                <Link
                  ...
                  className="border-b border-line py-3.5 text-[15px] text-ink-soft transition-colors duration-200 hover:text-ink"
                >
                  {t(link.key)}
                </Link>
              ))}
