...
import { usePrefs, type Theme } from "@/lib/app/prefs";
import type { AiRole, Difficulty, Language, TraineeRole } from "@/lib/app/prompt";
import { AI_ROLES, DIFFICULTIES, TRAINEE_ROLES } from "@/lib/app/scenarios";
